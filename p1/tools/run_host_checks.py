...
"""Run a fixed, host-only P1 subset without builds or framework test bootstrap.
...
DIRECTORIES = {
    ...
    "LMCache": "LMCache",
    "LMCache-Ascend": "LMCache/ascend",
}
EXPECTED_COUNTS = {"vllm": 16, "vllm-ascend": 31, "LMCache": 39, "LMCache-Ascend": 26}
...
def main() -> None:
    ...
    for repo in args.repo or CASES:
        directory = args.workspace.resolve() / DIRECTORIES[repo]
        ...
        try:
            ...
            log += "\nP1 host check timeout (180 seconds).\n"
        ...
        item = {
            ...
            "expected_tests": EXPECTED_COUNTS[repo],
            "argv": argv,
            "returncode": code,
            "counts": counts,
            "log_sha256": sha,
        ...
        failed |= (
            ...
            or counts.get("tests", 0) != EXPECTED_COUNTS[repo]
